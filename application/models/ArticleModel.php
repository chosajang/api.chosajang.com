...
SELECT
    ...
    C.ATTACHED_FILE_YN,
    C.ATTACHED_DOCUMENT_YN,
    C.COMMENT_YN
FROM TB_ARTICLE A
    INNER JOIN TB_MEMBER B ON B.SEQ = A.MEMBER_SEQ
    INNER JOIN TB_BOARD C ON C.SEQ = A.BOARD_SEQ
WHERE A.USE_YN = 'Y'
AND A.SEQ = ? ";
...
SELECT
    ...
    A.TITLE,
    LEFT(A.CONTENT,202)as CONTENT_PREVIEW,
    C.NAME,
    A.ADD_DATE,
    A.MOD_DATE
FROM TB_ARTICLE A
INNER JOIN TB_BOARD B ON B.SEQ = A.BOARD_SEQ AND B.USE_YN = 'Y'
