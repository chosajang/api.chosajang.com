...
SELECT
    ...
    C.NAME AS MEMBER_TITLE_NAME
FROM TB_ARTICLE A
    INNER JOIN TB_MEMBER B ON B.SEQ = A.MEMBER_SEQ
    INNER JOIN TB_MEMBER_TITLE C ON C.SEQ = B.MEMBER_TITLE_SEQ
WHERE A.USE_YN = 'Y'
AND A.SEQ = ? ";
...
FROM TB_COMMENT A
    ...
    INNER JOIN TB_MEMBER C ON C.SEQ = A.MEMBER_SEQ 
    INNER JOIN TB_MEMBER_TITLE CA ON CA.SEQ = C.MEMBER_TITLE_SEQ
